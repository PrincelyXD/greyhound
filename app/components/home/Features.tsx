...
export const Features = () => {
  ...
  return (
    <section id="features" className="py-24 md:p-32 relative">
      {/* Background accent */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Build and launch digital products faster with tools and solutions
            designed to scale seamlessly—whether for web, mobile, or enterprise
            software.
          </p>
        </div>
