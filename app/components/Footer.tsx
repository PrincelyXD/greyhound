export const Footer = () => {
  return (
    <footer className="bg-gray-950 border-t border-gray-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <a href="https://greyhound-steel.vercel.app/">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-5 text-white">Product</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-5 text-white">Resources</h3>
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
        ...
        <div className="border-t border-gray-800/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-xs">
            © 2025 Greyhound Smart Systems. All rights reserved.
          </p>
