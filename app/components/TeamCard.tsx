...
const TeamCard = ({role, name, className}:TeamCardProps) => {
  return (
    <motion.div className={`text-white bg-gray-400 w-[250px] relative h-72 flex justify-center ${className}  rounded-2xl overflow-hidden cursor-pointer transform-style-preserve-3d `}>

       <img src="/team-1.png" className='absolute -bottom-5 z-[3]' alt="" />
